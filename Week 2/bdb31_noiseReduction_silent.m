...
% method, predicitng noise from the inital silent portion of the file.
...
noise = x(1:2.8e4);                     % Extract silent portion of data
...
filename = [audio_file, '_filtered_silent.wav'];
